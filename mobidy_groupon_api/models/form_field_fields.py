...
class FormFieldFields(object):
    ...
    swagger_types = {
        'id': 'str',
        'fields': 'list[FormFieldpropertiesfieldsitems]',
        'hint': 'str',
        'label': 'str',
        'type': 'str',
        'value': 'str'
    ...
    def __init__(self, id=None, fields=None, hint=None, label=None, type=None, value=None):  # noqa: E501
        """FormFieldFields - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._fields = None
        self._hint = None
        self._label = None
    ...
    @property
    def id(self):
        """Gets the id of this FormFieldFields.  # noqa: E501
        ...
        :return: The id of this FormFieldFields.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this FormFieldFields.

        id of this question. This is `required` only for the top level question, ie not required for question within the nested *fields* property.  # noqa: E501

        :param id: The id of this FormFieldFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def fields(self):
        """Gets the fields of this FormFieldFields.  # noqa: E501
        ...
        :return: The fields of this FormFieldFields.  # noqa: E501
        :rtype: list[FormFieldpropertiesfieldsitems]
        """
        return self._fields

    @fields.setter
    def fields(self, fields):
        """Sets the fields of this FormFieldFields.

        This specifies the fields which are grouped together. A group may contain zero-to-many child groups, and there is no limit to how many times this nesting can occur. This is `required` for a field of *type* `GROUP`, as it specifies the fields within a group. A non-group field may contain zero-to-many fields. This data structure is used to support UI controls such as radio buttons or drop downs (using the `TEXT` *type*). A non-group field cannot have nested fields under these *fields*, nor may it contain `GROUP` *type* fields (i.e. a non-group field must have a flat list of child fields). Additionally, the child fields must have the same *property* as their parent field, and they must also have a *value*.  # noqa: E501

        :param fields: The fields of this FormFieldFields.  # noqa: E501
        :type: list[FormFieldpropertiesfieldsitems]
        """
    ...
    @property
    def hint(self):
        """Gets the hint of this FormFieldFields.  # noqa: E501
        ...
        :return: The hint of this FormFieldFields.  # noqa: E501
        :rtype: str
        """
        return self._hint
    ...
    @hint.setter
    def hint(self, hint):
        """Sets the hint of this FormFieldFields.

        Specifies a short hint that describes the expected value for this field. This may be used by a client to render a hint or placeholder value inside of an input field.  # noqa: E501

        :param hint: The hint of this FormFieldFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this FormFieldFields.  # noqa: E501

        The label value to display for this checkout field.  # noqa: E501

        :return: The label of this FormFieldFields.  # noqa: E501
        :rtype: str
        """
        return self._label
    ...
    def label(self, label):
        """Sets the label of this FormFieldFields.

        The label value to display for this checkout field.  # noqa: E501

        :param label: The label of this FormFieldFields.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this FormFieldFields.  # noqa: E501

        Enum of field types  # noqa: E501

        :return: The type of this FormFieldFields.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this FormFieldFields.

        Enum of field types  # noqa: E501

        :param type: The type of this FormFieldFields.  # noqa: E501
        :type: str
        """
        if type is None:
    ...
    @property
    def value(self):
        """Gets the value of this FormFieldFields.  # noqa: E501
        ...
        :return: The value of this FormFieldFields.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this FormFieldFields.

        The default value the client should use to populate this checkout field. For `BOOLEAN` types, this will be normalized to true or false when outputting the fields and will not be null. If the value is true, then it is recommended to display the UI control in the “on” state (e.g. checked for a checkbox or enabled for a toggle). For a `TEXT` type with child fields, this will indicate the selected or default value. This can be used to populate the UI control with a pre-selected value.  # noqa: E501

        :param value: The value of this FormFieldFields.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(FormFieldFields, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FormFieldFields):
            return False
